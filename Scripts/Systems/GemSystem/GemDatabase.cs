...
namespace ClawRPG.Scripts.Systems.GemSystem {
    ...
    public class GemDatabase {
        ...
        // 宝石ID -> 宝石数据
        private Dictionary<string, GemData> _gems = new Dictionary<string, GemData>();
        
        // 按类型索引
        private Dictionary<GemType, List<GemData>> _gemsByType = new Dictionary<GemType, List<GemData>>();
        
        // 按稀有度索引
        private Dictionary<GemRarity, List<GemData>> _gemsByRarity = new Dictionary<GemRarity, List<GemData>>();

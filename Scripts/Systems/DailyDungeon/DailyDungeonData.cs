...
public class DailyDungeonDatabase
{
    private static readonly List<DailyDungeonData> _dungeons = new List<DailyDungeonData>
    {
        ...
        new DailyDungeonData
        {
            Id = "abyss_easy",
            Name = "深渊之塔·简单",
            Type = DailyDungeonData.DungeonType.AbyssTower,
            Difficulty = DailyDungeonData.DifficultyLevel.Easy,
            RecommendedLevel = 1,
            TotalFloors = 5,
            TimeLimit = 300,
            GoldReward = 100,
        ...
        new DailyDungeonData
        {
            ...
            Name = "深渊之塔·普通",
            Type = DailyDungeonData.DungeonType.AbyssTower,
            Difficulty = DailyDungeonData.DifficultyLevel.Normal,
            RecommendedLevel = 20,
            TotalFloors = 10,
            TimeLimit = 600,
            GoldReward = 300,
        ...
        new DailyDungeonData
        {
            ...
            Name = "深渊之塔·困难",
            Type = DailyDungeonData.DungeonType.AbyssTower,
            Difficulty = DailyDungeonData.DifficultyLevel.Hard,
            RecommendedLevel = 40,
            TotalFloors = 15,
            TimeLimit = 900,
            GoldReward = 800,
        ...
        new DailyDungeonData
        {
            ...
            Name = "深渊之塔·史诗",
            Type = DailyDungeonData.DungeonType.AbyssTower,
            Difficulty = DailyDungeonData.DifficultyLevel.Epic,
            RecommendedLevel = 60,
            TotalFloors = 20,
            TimeLimit = 1200,
            GoldReward = 2000,
        ...
        new DailyDungeonData
        {
            ...
            Name = "深渊之塔·传奇",
            Type = DailyDungeonData.DungeonType.AbyssTower,
            Difficulty = DailyDungeonData.DifficultyLevel.Legendary,
            RecommendedLevel = 80,
            TotalFloors = 30,
            TimeLimit = 1800,
            GoldReward = 5000,
        ...
        new DailyDungeonData
        {
            Id = "dragon_easy",
            Name = "龙穴·简单",
            Type = DailyDungeonData.DungeonType.DragonLair,
            Difficulty = DailyDungeonData.DifficultyLevel.Easy,
            RecommendedLevel = 15,
            TotalFloors = 3,
            TimeLimit = 180,
        ...
        new DailyDungeonData
        {
            Id = "tomb_easy",
            Name = "远古墓穴·简单",
            Type = DailyDungeonData.DungeonType.AncientTomb,
            Difficulty = DailyDungeonData.DifficultyLevel.Easy,
            RecommendedLevel = 10,
            TotalFloors = 4,
            TimeLimit = 240,
        ...
        new DailyDungeonData
        {
            Id = "demon_easy",
            Name = "恶魔城堡·简单",
            Type = DailyDungeonData.DungeonType.DemonCastle,
            Difficulty = DailyDungeonData.DifficultyLevel.Easy,
            RecommendedLevel = 20,
            TotalFloors = 5,
            TimeLimit = 300,
        ...
        new DailyDungeonData
        {
            Id = "sacred_easy",
            Name = "神圣之地·简单",
            Type = DailyDungeonData.DungeonType.SacredGround,
            Difficulty = DailyDungeonData.DifficultyLevel.Easy,
            RecommendedLevel = 25,
            TotalFloors = 3,
            TimeLimit = 200,

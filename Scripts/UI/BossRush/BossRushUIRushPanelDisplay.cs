...
{
    public class BossRushUIRushPanelDisplay : Control
    {
        ...
        public void CreateElements(Control parent)
        {
            ...
            _statusLabel.SetAnchor(AnchorPreset.TopWide);
            ...
            _stageLabel.SetAnchor(AnchorPreset.TopWide);
            ...
            _streakLabel.SetAnchor(AnchorPreset.TopWide);
        ...
        private void CreateHealthBar(Control parent)
        {
            ...
            _healthBar.SetAnchor(AnchorPreset.TopWide);
            ...
            _healthLabel.SetAnchor(AnchorPreset.TopWide);
